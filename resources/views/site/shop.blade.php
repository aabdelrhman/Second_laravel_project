                            ...
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ Route('detail' , $item->id) }}" title="{{ $item->short_description }}">
                                        <figure><img src="{{asset('images/item/'.$item->images[1]->image)}}" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    ...
                                    <form action="{{ Route('addCart' , $item->id) }}" class="form_class" method="post">
                                        @csrf
                ...
                <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <form action="{{ Route('addCart' , 1) }}" class="form_class" method="post">
                                @csrf
                                <input type="submit" class="btn add-to-cart" value="Add To Cart"/>
                            </form>
                        ...
                        <li class="product-item">
                            <div class="product product-widget-style">
                                <div class="thumbnnail">
                                    <a href="{{ Route('detail' , $item->id) }}" title="{{ $item->short_description }}">
                                        <figure><img src="{{asset('images/item/'.$item->images[1]->image)}}" alt="{{ $item->short_description }}"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="#" class="product-name"><span>{{ $item->short_description }}</span></a>
                                    <div class="wrap-price"><span class="product-price">${{ $item->price }}</span></div>
                                </div>
                            </div>
                        </li>
